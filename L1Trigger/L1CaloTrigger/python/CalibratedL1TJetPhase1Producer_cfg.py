...
process.source = process.source = cms.Source("PoolSource",
  fileNames = cms.untracked.vstring("file:/hdfs/user/sb17498/CMS_Phase_2/jetMETStudies/ComputeUncalibratedPhase1AndAK4L1TJetsFromPfClustersAndCandidates_QCD_PUSubtractionBranch_PU200_Puppi_NoZeroPTJets/ComputeUncalibratedPhase1AndAK4L1TJetsFromPfClustersAndCandidates_QCD_PU200_Puppi_3738004.552.root")
)
...
#   inputCollectionTag = cms.InputTag("AK4JetFromPfClustersProducer", "AK4JetFromPfClusters", "UncalibratedL1TJetPhase1Producer"),
#   absEtaBinning = cms.vdouble(0, 1.4, 3, 6),
...
#   inputCollectionTag = cms.InputTag("AK4JetFromPfCandidatesProducer", "AK4JetFromPfCandidates", "UncalibratedL1TJetPhase1Producer"),
#   absEtaBinning = cms.vdouble(0, 1.4, 3, 6),
...
process.MatchAK4GenJetWithPhase1L1TJetFromPfCandidates = cms.EDAnalyzer('MatchGenJetToRecoCaloJet',
  genJetCollectionTag = cms.InputTag("ak4GenJetsNoNu", "", "HLT"),
  caloJetCollectionTag = cms.InputTag("CalibratePhase1L1TJetFromPfCandidates", "CalibratedPhase1L1TJetFromPfCandidates", "UncalibratedL1TJetPhase1Producer"),
)

process.MatchAK4GenJetWithAK4JetFromPfClusters = cms.EDAnalyzer('MatchGenJetToRecoCaloJet',
  genJetCollectionTag = cms.InputTag("ak4GenJetsNoNu", "", "HLT"),
  caloJetCollectionTag = cms.InputTag("CalibrateAK4JetFromPfClusters", "CalibratedAK4JetFromPfClusters", "UncalibratedL1TJetPhase1Producer"),
)

process.MatchAK4GenJetWithAK4JetFromPfCandidates = cms.EDAnalyzer('MatchGenJetToRecoCaloJet',
  genJetCollectionTag = cms.InputTag("ak4GenJetsNoNu", "", "HLT"),
  caloJetCollectionTag = cms.InputTag("CalibrateAK4JetFromPfCandidates", "CalibratedAK4JetFromPfCandidates", "UncalibratedL1TJetPhase1Producer"),
)
