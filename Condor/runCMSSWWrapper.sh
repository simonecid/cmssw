...
rm -r CMSSW_10_6_1_patch2/src
mkdir CMSSW_tmp 

/usr/bin/hdfs dfs -copyToLocal /user/sb17498/software/CMSSW_10_6_1_patch2.tar.gz CMSSW_tmp
cd CMSSW_tmp
tar xzvf CMSSW_10_6_1_patch2.tar.gz
mv CMSSW_10_6_1_patch2/src ../CMSSW_10_6_1_patch2/src
cd ..
